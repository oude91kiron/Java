/*---------------------------------------------------------------------------------------
Write a method called writeNums that an integer n as a parameter and prints             -
...
public class Q1
{
    ...
    public static void writeNums(int n)
    {
        ...
        } else if( n == 1)
        {
            ...
            writeNums(n - 1);           //----> 1 2 3 4 5 .. n-1 n
            System.out.print(n + " ");
            //writeNums(n - 1);         //----> n n-1 n-2 n-3 ..... 1
        }

    } // End of writeNums method
} // End of class